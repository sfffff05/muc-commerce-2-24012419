...
- 姓名：李清如
- 学号：24012419
- 已完成路由或接口：`/health`、`/api/metrics`、`/api/categories?category=`、`/api/ask`、统一400错误JSON响应
- 测试文件：`tests/test_app.py`（共8条测试，覆盖健康检查、指标接口、品类筛选、问答接口及登录流程）
- 尚未解决的问题：无
